  ...
  public: {
    Tables: {
      admin_section_visibility: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_section_visibility_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      analytics_summary: {
        ...
        Relationships: [
          {
            foreignKeyName: "analytics_summary_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      catalog_display_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "catalog_display_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      delivery_addresses: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_addresses_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      delivery_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      email_subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_subscriptions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      header_collections: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "header_collections_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      header_menu_settings: {
        Row: {
          ...
          selected_category_ids_right: string[] | null
        ...
        Relationships: [
          {
            foreignKeyName: "header_menu_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      home_page_blocks: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "home_page_blocks_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      lookbook_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "lookbook_items_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_color_images: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_color_images_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_colors: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_colors_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_recommendations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_recommendations_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      seo_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "seo_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_actions: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_actions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      yandex_payment_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "yandex_payment_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
